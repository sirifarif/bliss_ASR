...
SYSTEM_NAME = "Dutch Automatic Speech Recognition System"

#An informative description for this system (this should be fairly short, about one paragraph, and may not contain HTML)
SYSTEM_DESCRIPTION = "This webservice uses automatic speech recognition for BLISS project. You can upload and process only one file per project. For bulk processing and other questions, please contact Henk van den Heuvel at h.vandenheuvel@let.ru.nl."

SYSTEM_AUTHOR = "Arif Khan"

SYSTEM_AFFILIATION = "Centre for Language and Speech Technology, Radboud University"

SYSTEM_URL = "https://github.com/sirifarif/bliss_ASR"
...
#
# COMMAND = WEBSERVICEDIR + "/bliss_ASR_wrapper.sh $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"
#Or for the shell variant:

#SCRATCHDIRECTORY is set in config.yml
#RESOURCEDIRECTORY is set in config.yml

COMMAND = WEBSERVICEDIR + "/bliss_ASR_wrapper.sh $STATUSFILE $INPUTDIRECTORY $OUTPUTDIRECTORY "+SCRATCHDIRECTORY+" "+WEBSERVICEDIR+" "+RESOURCEDIRECTORY+" $PARAMETERS"
